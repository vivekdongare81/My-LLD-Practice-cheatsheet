...
import com.lld.digital_wallet_system.payment.BankAccountPayment;
import com.lld.digital_wallet_system.payment.CreditCardPayment;
...
public class App {
  public static void main(String[] args) {
    ...
    // Link payment methods for Depositing money into the wallet - From a credit card or bank account
    PaymentStrategy creditCard = new CreditCardPayment("PM001", user1, "1234567890123456", "12/25", "123");
    PaymentStrategy bankAccount = new BankAccountPayment("PM002", user2, "9876543210", "987654321");
