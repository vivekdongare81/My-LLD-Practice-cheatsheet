...
import com.lld.hotel_management.payment.Payment;
import com.lld.hotel_management.payment.CreditCardPayment;
...
public class App {
  public static void main(String[] args) {
    ...
    Reservation reservation1 =
        hotelManagementSystem.bookRoom(guest1, room1, checkInDate, checkOutDate);
